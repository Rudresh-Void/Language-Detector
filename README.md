...
python app.py
```
If it doesn't run then try download this repository.
and follow these steps.
Step 1 : Open app.py and edit line "6", 
Step 2 : Now select and eddit "model = joblib.load("language_detector.pkl")" with "model = joblib.load(r"path of language_detector.pkl")"
